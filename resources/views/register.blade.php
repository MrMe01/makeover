...
@section('content')
	...
	<div class="animation-container">
		...
		<div class="form-step js-form-step" data-step="1">
			...
			<p class="form-instructions"><strong>Click the "continue" button to continue with the registration .</strong></p>
			...
			<div class="form-step js-form-step waiting hidden" data-step="2">
				...
				<form action="" name="form-step-2">
						...
						<div class="fieldgroup">
								<input type="text" name="Address" id="token" />
			...
			<div class="form-step js-form-step waiting hidden" data-step="3">
				...
				<form action="" name="form-step-3">
						<div class="fieldgroup">
                         ...
                         <div class="fieldgroup">
                          <h3>Account type</h3>
                            <label class="containerchec">User
                              <input type="radio" checked="checked" name="radio">
                              <span class="checkmark"></span>
                            </label>
                            <label class="containerchec">Branch
						 ...
						 <div class="body-card">
                                ...
                                <div class="form-container">
                                    <div class="field-container">
                                        <label for="name">Name</label>
                                        <input id="name" maxlength="25" type="text">
                                    </div>
                                    <div class="field-container">
